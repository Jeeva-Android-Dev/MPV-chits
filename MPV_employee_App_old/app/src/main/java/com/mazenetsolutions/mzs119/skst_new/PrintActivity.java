...
public class PrintActivity extends AppCompatActivity {
    ...
    public void builddilogdecline() {
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(
                PrintActivity.this, R.style.MyAlertDialogStyleDeclined);
            ...
            if (amntlen <= 32) {
                ...
                for (int j = 0; j < dumlength; j++) {
                    Amount = " "+Amount ;
                        ...
                        String return_val_in_english1 = EnglishNumberToWords.convert(Integer.parseInt(Amount));
                        try {
                        ...
                        BluetoothPrintDriver.BT_Write("Rs " + Receivedamnt + " (" + return_val_in_english1 + " only)" + "\n");
                        //   BluetoothPrintDriver.LF();
                        try {
                        ...
                        BluetoothPrintDriver.BT_Write("Rs " + Pendingamnt + "\n");
            ...
            if (amntlen <= 32) {
                ...
                for (int j = 0; j < dumlength; j++) {
                    paymode = " "+paymode ;
                        ...
                        BluetoothPrintDriver.BT_Write("Rs " + Advanceamntt + "\n");
                        // BluetoothPrintDriver.LF();
